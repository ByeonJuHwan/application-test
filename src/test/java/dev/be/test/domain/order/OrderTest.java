package dev.be.test.domain.order;
...
class OrderTest {
    ...
    void calculateTotalPrice() {
        ...
        List<Product> products =
                List.of(createProduct("001", 1000), createProduct("002", 3000));
    ...
    @DisplayName("주문 생성 시 상품 리스트에서 주문의 상태는 INIT 이다")
    @Test
    void init() {
        //given
        List<Product> products =
                List.of(createProduct("001", 1000), createProduct("002", 2000));
